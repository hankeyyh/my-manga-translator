/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.workflow.jsonc --env-interface=WorkflowEnv workflow-env.d.ts` (hash: 37fd72541f8de29b7699f7da4c1beaa2)
// Runtime types generated with workerd@1.20260611.1 2026-06-14 nodejs_compat
interface __BaseEnv_WorkflowEnv {
	NEXT_PUBLIC_SUPABASE_URL?: "http://127.0.0.1:64321" | "https://hdgbsqylotetyjfhaykl.supabase.co";
	MANGA_IMAGE_TRANSLATOR_BASE_URL?: "http://127.0.0.1:8000" | "https://hankeyyh--manga-translator-web.modal.run";
	MANGA_TRANSLATOR_BASE_URL?: "https://hankeyyh--manga-translator-mt-web-dev.modal.run" | "https://hankeyyh--manga-translator-mt-web.modal.run";
	TRANSLATE_BATCH_SIZE?: 4;
	FORCE_TRANSLATE_FAIL?: 0;
	NEXTJS_ENV: string;
	...
	MT_API_KEY: string;
	MY_WORKFLOW?: Workflow<Parameters<import("./biz/workers/workflow").MyWorkFlow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./biz/workers/workflow");
	}
	interface DevEnv {
		NEXT_PUBLIC_SUPABASE_URL: "http://127.0.0.1:64321";
		MANGA_IMAGE_TRANSLATOR_BASE_URL: "http://127.0.0.1:8000";
		MANGA_TRANSLATOR_BASE_URL: "https://hankeyyh--manga-translator-mt-web-dev.modal.run";
		TRANSLATE_BATCH_SIZE: 4;
		FORCE_TRANSLATE_FAIL: 0;
		NEXTJS_ENV: string;
		STRIPE_SECRET_KEY: string;
	...
	interface ProdEnv {
		...
		MANGA_IMAGE_TRANSLATOR_BASE_URL: "https://hankeyyh--manga-translator-web.modal.run";
		MANGA_TRANSLATOR_BASE_URL: "https://hankeyyh--manga-translator-mt-web.modal.run";
		TRANSLATE_BATCH_SIZE: 4;
		NEXTJS_ENV: string;
		STRIPE_SECRET_KEY: string;
		STRIPE_WEBHOOK_SIGNING_SECRET: string;
	...
	interface Env extends __BaseEnv_WorkflowEnv {}
}
interface WorkflowEnv extends __BaseEnv_WorkflowEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SUPABASE_URL" | "MANGA_IMAGE_TRANSLATOR_BASE_URL" | "MANGA_TRANSLATOR_BASE_URL" | "TRANSLATE_BATCH_SIZE" | "FORCE_TRANSLATE_FAIL" | "NEXTJS_ENV" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SIGNING_SECRET" | "SUPABASE_AUTH_EXTERNAL_GOOGLE_CLIENT_SECRET" | "SUPABASE_SERVICE_ROLE_KEY" | "MT_API_KEY">> {}
}
