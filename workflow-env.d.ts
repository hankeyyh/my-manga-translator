/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.workflow.jsonc --env-interface=WorkflowEnv workflow-env.d.ts` (hash: 01a707bf3a74a1a0da5f70430dff3f82)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SUPABASE_URL" | "MANGA_IMAGE_TRANSLATOR_BASE_URL" | "TRANSLATE_BATCH_SIZE" | "FORCE_TRANSLATE_FAIL" | "NEXTJS_ENV" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SIGNING_SECRET" | "SUPABASE_AUTH_EXTERNAL_GOOGLE_CLIENT_SECRET" | "SUPABASE_SERVICE_ROLE_KEY">> {}
}
