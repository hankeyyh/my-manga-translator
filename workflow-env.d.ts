/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.workflow.jsonc --env-interface=WorkflowEnv workflow-env.d.ts` (hash: aa4db45e2f7e14726bb74ed00482c842)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SUPABASE_URL" | "MANGA_IMAGE_TRANSLATOR_BASE_URL" | "CONCURRENT_IMAGES" | "NEXTJS_ENV" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SIGNING_SECRET" | "SUPABASE_AUTH_EXTERNAL_GOOGLE_CLIENT_SECRET" | "SUPABASE_SERVICE_ROLE_KEY">> {}
}
