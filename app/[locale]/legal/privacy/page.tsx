...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const result = await LegalService.fromSupabase(supabase).getPublishedDocument("privacy", await getLocale());
    return { title: `${result.data?.title ?? t("privacy")} | Manga Sense` };
}
